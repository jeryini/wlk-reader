...
/**
 * WeatherDataRecord class represents standard archive record.
 *
 * @author Jernej Jerin
 * @version 0.1
 * @since 2012-02-08
...
public class WeatherDataRecord extends Struct {
	...
	// For weather data record the dataType = 1.
	...
	// Used to calculate extra heating effects of the sun
	// in THSW index.
	...
	/*
	 * WeatherDataRecord is packed. That means no bytes are added to make
